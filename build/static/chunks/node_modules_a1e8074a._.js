...
var Deferred = class {
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "promise", void 0);
...
"[project]/node_modules/react-router/node_modules/cookie/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$node_modules$2f$cookie$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-router/node_modules/cookie/dist/index.js [app-client] (ecmascript)");
...
function convertRoutesToDataRoutes(routes, mapRouteProperties2) {
    let parentPath = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [], manifest = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
...
function createRouter(init) {
    ...
    async function handleAction(request, location, submission, matches, scopedContext, isFogOfWar) {
        let opts = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : {};
        interruptActiveLoads();
    ...
    async function fetch2(key, routeId, href2, opts) {
        ...
        let flushSync = (opts && opts.flushSync) === true;
        let routesToUse = inFlightDataRoutes || dataRoutes;
        let normalizedPath = normalizeTo(state.location, state.matches, basename, href2, routeId, opts === null || opts === void 0 ? void 0 : opts.relative);
...
function createStaticHandler(routes, opts) {
    ...
    async function query(request) {
        let { requestContext, filterMatchesToLoad, skipLoaderErrorBubbling, skipRevalidation, dataStrategy, unstable_respond: respond } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    ...
    async function queryRoute(request) {
        let { routeId, requestContext, dataStrategy, unstable_respond: respond } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        let url = new URL(request.url);
        let method = request.method;
        let location = createLocation("", createPath(url), null, "default");
        let matches = matchRoutes(dataRoutes, location, basename);
...
function getLoaderMatchesUntilBoundary(matches, boundaryId) {
    let includeBoundary = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
...
async function callRouteMiddleware(args, middlewares, middlewareState, handler) {
...
function Router(param) {
    let { basename: basenameProp = "/", children = null, location: locationProp, navigationType = "POP" /* Pop */ , navigator: navigator2, static: staticProp = false } = param;
    ...
    return async (args)=>{
        ...
        if (!ssr) {
            let foundRevalidatingServerLoader = matches.some((m)=>{
                var _manifest_routes_m_route_id, _manifest_routes_m_route_id1;
                return m.shouldLoad && ((_manifest_routes_m_route_id = manifest.routes[m.route.id]) === null || _manifest_routes_m_route_id === void 0 ? void 0 : _manifest_routes_m_route_id.hasLoader) && !((_manifest_routes_m_route_id1 = manifest.routes[m.route.id]) === null || _manifest_routes_m_route_id1 === void 0 ? void 0 : _manifest_routes_m_route_id1.hasClientLoader);
            });
...
async function nonSsrStrategy(manifest, request, matches, basename) {
    ...
    await Promise.all(matchesToLoad.map((m)=>m.resolve(async (handler)=>{
            try {
                var _manifest_routes_m_route_id;
                let result = ((_manifest_routes_m_route_id = manifest.routes[m.route.id]) === null || _manifest_routes_m_route_id === void 0 ? void 0 : _manifest_routes_m_route_id.hasClientLoader) ? await fetchSingleLoader(handler, url, init, m.route.id) : await handler();
                results[m.route.id] = {
                    type: "data",
                    result
                };
...
function useFogOFWarDiscovery(router, manifest, routeModules, ssr, isSpaMode) {
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "useFogOFWarDiscovery.useEffect": ()=>{
            ...
            if (!isFogOfWarEnabled(ssr) || ((_navigator_connection = navigator.connection) === null || _navigator_connection === void 0 ? void 0 : _navigator_connection.saveData) === true) {
                return;
            }
...
async function fetchAndApplyManifestPatches(paths, errorReloadPath, manifest, routeModules, ssr, isSpaMode, basename, patchRoutes, signal) {
    let manifestPath = "".concat(basename != null ? basename : "/", "/__manifest").replace(/\/+/g, "/");
...
function StaticRouterProvider(param) {
    let { context, router, hydrate = true, nonce } = param;
...
var createCookie = function(name) {
    let cookieOptions = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    let { secrets = [], ...options } = {
        path: "/",
        sameSite: "lax",
        ...cookieOptions
...
function createRoutes(manifest) {
    let parentId = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "", routesByParentId = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : groupRoutesByParentId2(manifest);
    return (routesByParentId[parentId] || []).map((route)=>({
            ...route,
...
function createStaticHandlerDataRoutes(manifest, future) {
    let parentId = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "", routesByParentId = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : groupRoutesByParentId2(manifest);
    return (routesByParentId[parentId] || []).map((route)=>{
        let commonRoute = {
            ...
            loader: route.module.loader ? async (args)=>{
                if (args.request.headers.has("X-React-Router-Prerender-Data")) {
                    ...
                    let decoded = await decodeViaTurboStream(stream, /*TURBOPACK member replacement*/ __turbopack_context__.g);
...
function getDocumentHeaders(build, context) {
    ...
    return matches.reduce((parentHeaders, match, idx)=>{
        ...
        invariant3(route, 'Route with id "'.concat(id, '" not found in build'));
...
function generateSingleFetchResponse(request, build, serverMode, param) {
...
function derive(build, mode) {
    ...
    let errorHandler = build.entry.module.handleError || ((error, param)=>{
        let { request } = param;
    ...
    return async function requestHandler(request, initialContext) {
        ...
        let handleError = (error)=>{
            if (mode === "development" /* Development */ ) {
                ...
                (_getDevServerHooks = getDevServerHooks()) === null || _getDevServerHooks === void 0 ? void 0 : (_getDevServerHooks_processRequestError = _getDevServerHooks.processRequestError) === null || _getDevServerHooks_processRequestError === void 0 ? void 0 : _getDevServerHooks_processRequestError.call(_getDevServerHooks, error);
            }
            errorHandler(error, {
                context: loadContext,
                params,
        ...
        let manifestUrl = "".concat(normalizedBasename, "/__manifest").replace(/\/+/g, "/");
        ...
        if (url.pathname.endsWith(".data")) {
            ...
            } else if (mode === "development" /* Development */  && ((_getDevServerHooks = getDevServerHooks()) === null || _getDevServerHooks === void 0 ? void 0 : _getDevServerHooks.getCriticalCss)) {
                var _getDevServerHooks_getCriticalCss, _getDevServerHooks1;
                criticalCss = await ((_getDevServerHooks1 = getDevServerHooks()) === null || _getDevServerHooks1 === void 0 ? void 0 : (_getDevServerHooks_getCriticalCss = _getDevServerHooks1.getCriticalCss) === null || _getDevServerHooks_getCriticalCss === void 0 ? void 0 : _getDevServerHooks_getCriticalCss.call(_getDevServerHooks1, pathname));
            }
...
var createSession = function() {
    let initialData = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, id = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
...
function createSessionStorage(param) {
    let { cookie: cookieArg, createData, readData, updateData, deleteData } = param;
...
function createCookieSessionStorage() {
    let { cookie: cookieArg } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    let cookie = isCookie(cookieArg) ? cookieArg : createCookie((cookieArg === null || cookieArg === void 0 ? void 0 : cookieArg.name) || "__session", cookieArg);
    warnOnceAboutSigningSessionCookie(cookie);
    return {
        async getSession (cookieHeader, options) {
...
//# sourceMappingURL=node_modules_a1e8074a._.js.map